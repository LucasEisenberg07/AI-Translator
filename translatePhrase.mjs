 ...
 * @param {object} client - The OpenAI API client.
 ...
 */
export async function translatePhrase(phrase, language, wrongAnswers, contextMap, startingLanguage, client, model, regenerate) {
    let translations = {};
    ...
    if (language === "this is a test phrase") {
        return prompt;
    }
